 ...
 * </p>
 */
public class TimeInMillisConfigurationPane extends AbstractNumberConfigurationPane {
    
    public DataEncoding getDataEncoding() {
        return DataEncodingFactory.getDataEncoding(new TimeInMillis(isLittleEndian()));
    }
}
