 ...
 * </p>
 */
public class RepeatLengthPane extends JPanel implements ActionListener, LocaleStrings
{
	 ...
	 *	Constructors
	 */
	public RepeatLengthPane(String label)
	{
		super();
		setLayout(new BoxLayout(this, BoxLayout.Y_AXIS));

		IntegerFormatFactory integerFormat = DataWorkshop.getInstance().getIntegerFormatFactory();
		staticLengthPane = new StaticLengthPane(integerFormat.getUnsignedCount(), label);
		pointerLengthPane = new PointerLengthPane(integerFormat.getSignedCount(), label);
